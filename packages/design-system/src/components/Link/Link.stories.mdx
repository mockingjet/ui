...
You may need the style of a link but the behavior of a button.

For this, use the provided `as` props.

<Canvas>
	<Story story={Stories.AsButton} />
</Canvas>
...
<Canvas>
	<Story
		...
		argTypes={{
			...
			as: {
				description:
					'Polymorphic prop to give this style to a button. `string` `ReactComponentType`.',
				control: false,
			},
		}}
	>
